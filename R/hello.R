...
match_names <- function() {
  ...
  WPAdata<-data.frame(Appendix <- c("APPENDIX I",
                      ...
                      Scientific_Name <- c("Agave parviflora",
                                           ...
                                           "Euphorbia cremersii (Includes thefomza viridifolia and the variety rakotozafyi.",
  ...
  matched <- merge(Userdata, WPAdata, by.x = "Name", by.y = "Scientific_Name", all.x = TRUE)

  # Replace NAs with 'Not matched' for unmatched entries
  matched$Appendix[is.na(matched$Appendix)] <- "--Do not match--"

  # Select relevant columns to return
  result <- matched[, c("Name", "Appendix")]
  names(result) <- c("Scientific_Name", "Appendix")
